...
<#escape x as x?html>
  <@html title="确认单（机票+酒店）">
    ...
    <div class="main-body stamp01">
      ...
      <ul class="order-info multi clearfix fwn">
      ...
      <div>
        ...
        <div class="section">
          ...
          <p>3.     机票于 <span class="hl-red">6月8日</span> 确认开票，请仔细核对名单，并确保提供的名单与证件号码相符，团队机票一经确认开票不得改签、不得更改、不得退票。</p>
      ...
      <div class="account-body">
        ...
        <div class="section clearfix">
          <div class="party">
            ...
            <p>账号： <strong>020 1010 400 21745</strong></p>
            <p>开户行：杭州农业银行城西支行行</p>
          </div>
          <div class="party">
            <p>个人储蓄卡：</p>
            <p>开户名：俞丽娜</p>
            <p>账  号： <strong>62284 8032 2891 836411</strong></p>
            <p>开户行：中国农业银行杭州吴山支行</p>
          </div>
        </div>
      </div>
      <div>
        <h2 class="sub-title text-center">欠款确认证明</h2>
        <div class="section">
          <p class="ti2">
      ...
      <div>
        <h2 class="sub-title text-center">担保书</h2>
        <div class="section clearfix">
          <p>浙江中山国际旅行社有限责任公司：</p>
          <p class="ti2">兹证明订单确认单游客名单人员为我公司参加贵公司组织的 <span class="hl-red">ZJZST-130614BR6（魅力台湾豪华6日游（北高））</span>旅游团的客人，我公司保证这些客人均经我社严格审查，将按时随团回国；如发生客人滞留不归或未按时随团回国及擅自离团现象，一切责任由我公司承担，同意支付贵公司每人人民币伍万元的风险赔偿金。</p>
      ...
      <p class="order-confirm">请对上述内容仔细审核，如无异意请盖章确认并回传我社,传真号码：<span class="hl-red">0571-87026789</span>，谢谢配合！</p>
    </div>
    </@body>
  </@html>
</#escape>
