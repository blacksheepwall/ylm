      ...
      <div class="center">
            ...
            <div class="clearfix">
              <div class="pull-left">
                <div>
                  ...
                  <span>2晚钻石五星酒店+3晚独栋泳池别墅，宝格丽海景下午茶+龙目岛离岛</span>
                </div>
                <div class="muted">产品编号：YCJIS58PA130518B</div>
              </div>
            </div>
          </div>
          <div class="clearfix">
            <div class="carousel pull-left" id="carousel-373696">
              ...
              <div class="carousel-inner">
                <div class="item">
                  <img alt="" src="http://img0.ph.126.net/jt-Itit4bt3_Fo4NOGR33A==/885238801855149183.jpg">
                ...
                <div class="item active">
                  <img alt="" src="http://img0.ph.126.net/ppyAiBA9neIMh0ivnLHt6g==/1875186294946526982.jpg">
                  <div class="carousel-caption">
                    <h4>
                ...
                <div class="item">
                  <img alt="" src="http://img1.ph.126.net/QmwZKF0j8Pit4Qe2XDpdSA==/294141350762771002.jpg">
                  <div class="carousel-caption">
                    <h4>
        ...
        <div>
          ...
          <div data-spy="scroll" data-target="#J_nav_tabs" data-offset="0">
            <h3 id="route">产品行程</h3>
            <div>Veniam marfa mustache skateboard, adipisicing fugiat velit pitchfork beard. Freegan beard aliqua cupidatat mcsweeney's vero. Cupidatat four loko nisi, ea helvetica nulla carles. Tattooed cosby sweater food truck, mcsweeney's quis non freegan vinyl. Lo-fi wes anderson +1 sartorial. Carles non aesthetic exercitation quis gentrify. Brooklyn adipisicing craft beer vice keytar deserunt.</div>
            <h3 id="description">产品说明</h3>
            <div>Veniam marfa mustache skateboard, adipisicing fugiat velit pitchfork beard. Freegan beard aliqua cupidatat mcsweeney's vero. Cupidatat four loko nisi, ea helvetica nulla carles. Tattooed cosby sweater food truck, mcsweeney's quis non freegan vinyl. Lo-fi wes anderson +1 sartorial. Carles non aesthetic exercitation quis gentrify. Brooklyn adipisicing craft beer vice keytar deserunt.</div>
            <h3 id="notice">签证须知</h3>
            <div>Veniam marfa mustache skateboard, adipisicing fugiat velit pitchfork beard. Freegan beard aliqua cupidatat mcsweeney's vero. Cupidatat four loko nisi, ea helvetica nulla carles. Tattooed cosby sweater food truck, mcsweeney's quis non freegan vinyl. Lo-fi wes anderson +1 sartorial. Carles non aesthetic exercitation quis gentrify. Brooklyn adipisicing craft beer vice keytar deserunt.</div>
            <h3 id="prepare">出行准备</h3>
            <div>Veniam marfa mustache skateboard, adipisicing fugiat velit pitchfork beard. Freegan beard aliqua cupidatat mcsweeney's vero. Cupidatat four loko nisi, ea helvetica nulla carles. Tattooed cosby sweater food truck, mcsweeney's quis non freegan vinyl. Lo-fi wes anderson +1 sartorial. Carles non aesthetic exercitation quis gentrify. Brooklyn adipisicing craft beer vice keytar deserunt.</div>
            <h3 id="order">预订订单</h3>
            <div>Veniam marfa mustache skateboard, adipisicing fugiat velit pitchfork beard. Freegan beard aliqua cupidatat mcsweeney's vero. Cupidatat four loko nisi, ea helvetica nulla carles. Tattooed cosby sweater food truck, mcsweeney's quis non freegan vinyl. Lo-fi wes anderson +1 sartorial. Carles non aesthetic exercitation quis gentrify. Brooklyn adipisicing craft beer vice keytar deserunt.</div>
            <h3 id="relate">相关线路</h3>
            <div>Veniam marfa mustache skateboard, adipisicing fugiat velit pitchfork beard. Freegan beard aliqua cupidatat mcsweeney's vero. Cupidatat four loko nisi, ea helvetica nulla carles. Tattooed cosby sweater food truck, mcsweeney's quis non freegan vinyl. Lo-fi wes anderson +1 sartorial. Carles non aesthetic exercitation quis gentrify. Brooklyn adipisicing craft beer vice keytar deserunt.</div>
          </div>
        </div>
      </div>
