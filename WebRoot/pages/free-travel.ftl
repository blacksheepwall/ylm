  ...
  <@html title="自由行">
    ...
    <div class="free-travel main-body clearfix">
      <div class="condition">
        ...
        <ul id="J_condition" class="mod-body mod-condition form-horizontal">
      ...
      <li>
        <div class="product clearfix" style="display: block;">
          <div class="product-main">
            <div>
              <span class="label label-success">【机票+酒店】</span>
              <a class="title" href="/ziyouxing/detail/?id={{productId}}"><strong>{{title}}</strong></a>
              ...
              <div class="product-date pull-left">
                <strong>日期：</strong>
                {{#each leaveDates}}
                  <a href="javascript:;" class="date-value">{{dateRenderer .}}</a>
                {{/each}}
                <a href="javascript:;" class="date-more">更多 »</a>
              </div>
            </div>
          ...
          <div class="product-more">
            ...
            <div class="show-detail text-center">
              <a class="btn btn-success btn-small" href="/ziyouxing/detail/?id={{productId}}">查看详情</a>
            </div>
          </div>
        </div>
      </li>
